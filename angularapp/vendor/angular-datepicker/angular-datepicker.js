...
Module.filter('mFormat', function () {
  return function (m, format, tz) {
    ...
    if (!(moment.isMoment(m))) {
      formattedValue = m ? moment(m).format(format) : '';
    } else {
      formattedValue = tz ? moment.tz(m, tz).format(format) : m.format(format);
    }
...
Module.directive('datePicker', ['datePickerConfig', 'datePickerUtils', function datePickerDirective(datePickerConfig, datePickerUtils) {
  ...
  return {
    ...
    link: function (scope, element, attrs, ngModel) {
      ...
      scope.stopEventBubbling = function(e) {
        e.stopPropagation();
      };
      ...
      scope.setView = function (nextView, e) {
        if (e) {
          e.stopPropagation();
        }
      ...
      scope.selectDate = function (date, e) {
        if (e) {
          e.stopPropagation();
        }
        ...
        if (view === 'date') {
          ...
          for (i = 0; i < weeks.length; i++) {
            ...
            for (j = 0; j < week.length; j++) {
              classList = '';
              // if scope.model is null - we have initial state, no date were selected
              if (scope.model && datePickerUtils.isSameDay(date, week[j])) {
                classList += 'active';
              }
          ...
          for (i = 0; i < dates.length; i++) {
            classList = '';
            // if scope.model is null - we have initial state, no date were selected
            if (scope.model && datePickerUtils[compareFunc](date, dates[i])) {
              classList += 'active';
            }
      ...
      scope.prev = function (delta, e) {
        return scope.next(-delta || -1, e);
      };
...
Module.directive('dateTime', ['$compile', '$document', '$filter', 'dateTimeConfig', '$parse', 'datePickerUtils', '$window', function ($compile, $document, $filter, dateTimeConfig, $parse, datePickerUtils, $window) {
    ...
    link: function (scope, element, attrs, ngModel) {
      ...
      if (angular.isDefined(attrs.minDate)) {
        ...
        ngModel.$validators.min = function (value) {
        	return moment.isMoment(value) && minDate && (minDate.isSame(value) || minDate.isBefore(value));
        };
      }
      ...
      if (angular.isDefined(attrs.maxDate)) {
        ...
        ngModel.$validators.max = function (value) {
        	return moment.isMoment(value) && minDate && (maxDate.isSame(value) || maxDate.isAfter(value));
        };
      }
      ...
      function showPicker() {
        ...
        if (position === 'absolute') {
          ...
          var right = angular.element($window).width() - pos.left - element.outerWidth();
          picker.css({ top: pos.top + pos.height, right: right, display: 'block', position: position });
          body.append(picker);
        } else {
          // relative
          ...
          container.css({ top: element.outerHeight(), right: '0', display: 'block' });
        }
...
$templateCache.put('templates/datepicker.html',
    "<div ng-switch=\"view\" ng-click=\"stopEventBubbling($event)\">\r" +
    "\n" +
    ...
    "      <tr>\r" +
    "\n" +
    "        <th ng-click=\"prev(null, $event)\">&lsaquo;</th>\r" +
    "\n" +
    "        <th colspan=\"5\" class=\"switch\" ng-click=\"setView('month', $event)\" ng-bind=\"date|mFormat:'YYYY MMMM':tz\"></th>\r" +
    "\n" +
    "        <th ng-click=\"next(null, $event)\">&rsaquo;</i></th>\r" +
    "\n" +
    "      </tr>\r" +
    "\n" +
    "      <tr>\r" +
    ...
    "\n" +
    "            ng-click=\"selectDate(day, $event)\" ng-bind=\"day|mFormat:'DD':tz\"></span>\r" +
    "\n" +
    "        </td>\r" +
    "\n" +
    "      </tr>\r" +
    ...
    "\n" +
    "                ng-click=\"selectDate(year, $event)\" ng-bind=\"year.year()\"></span>\r" +
    "\n" +
    "        </td>\r" +
    "\n" +
    "      </tr>\r" +
    ...
    "        <th ng-click=\"prev(null, $event)\">&lsaquo;</th>\r" +
    "\n" +
    "        <th colspan=\"5\" class=\"switch\" ng-click=\"setView('year', $event)\" ng-bind=\"date|mFormat:'YYYY':tz\"></th>\r" +
    "\n" +
    "        <th ng-click=\"next(null, $event)\">&rsaquo;</i></th>\r" +
    "\n" +
    "      </tr>\r" +
    ...
    "\n" +
    "                ng-click=\"selectDate(month, $event)\"\r" +
    "\n" +
    ...
    "      <tr>\r" +
    "\n" +
    "        <th ng-click=\"prev(24, $event)\">&lsaquo;</th>\r" +
    "\n" +
    "        <th colspan=\"5\" class=\"switch\" ng-click=\"setView('date', $event)\" ng-bind=\"date|mFormat:'DD MMMM YYYY':tz\"></th>\r" +
    "\n" +
    "        <th ng-click=\"next(24, $event)\">&rsaquo;</i></th>\r" +
    "\n" +
    "      </tr>\r" +
    "\n" +
    "      </thead>\r" +
    ...
    "        <th ng-click=\"prev(null, $event)\">&lsaquo;</th>\r" +
    "\n" +
    "        <th colspan=\"5\" class=\"switch\" ng-click=\"setView('hours', $event)\" ng-bind=\"date|mFormat:'DD MMMM YYYY':tz\"></th>\r" +
    "\n" +
    "        <th ng-click=\"next(null, $event)\">&rsaquo;</i></th>\r" +
    "\n" +
    "      </tr>\r" +
